...
<Post data={data.postData} showPostList>
    ...
    <p>
        ...
        The last few months have been uplifting for me, and what's to come seemed even more promising, at first that is.
        Let's do this.
    </p>
    ...
    <p>
        I had a chat with K at the end of the summer break if she runs again (she got elected the year prior).
    ...
    <ol>
        <li>You have to give a speech at the graduation ceremony</li>
        <li>You are responsible for coordinating class reunion meetings</li>
    </ol>
    ...
    <p>
        ...
        Dare I put it into writing: <em>I had a friend.</em>
    </p>
    ...
    <p>
        ...
        And she did and gave me the only helpful advice that you can give to someone in this situation: Wait and figure
        yourself out before saying something wrong.
        ...
        But all of this will be part of a future post (we must stay chronological, you know).
    </p>

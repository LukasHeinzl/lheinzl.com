...
<Post data={data.postData} showPostList>
    ...
    <p>
        We had to work for 45h per week, walking around the entire day, moving patients with wheelchairs or their entire
        beds.
        ...
        Back then I thought that this was a very helpful phase to get back on track, but now I know that I have just
        suppressed my problems instead of working on them.
    </p>

    <p>
        Now back to Covid.
        Since we were civil servants, we could not be fired due to lockdown.
        We had to stay in service.
        But because the hospitals were shut down to protect them, we did not have any work.
        This meant that we got to hang out with each other, not having much to do, while everyone else had to stay at
        home.
        ...
        This was due to the fact that staff had been fired, and because all the patients who were waiting for their
        operations had to be rescheduled.
        Therefore, the summer months were extremely stressful.
        On the flip side: I applied for university and got accepted, which was great, especially since I previously had
        no desire to attend university.
    ...
    <p>
        ...
        Every week one civil servant would be solely responsible for the cardiology operating room - bringing patients
        to/from the operating room.
        For me, this was always a great pleasure since the team there was really nice and because I found the technology
        behind it fascinating.
        It was, however, also one of the most stressful things when there is an emergency and a patient's life is (at
        least partially) in your hands.
    </p>

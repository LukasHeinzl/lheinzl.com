...
<Post data={data.postData} showPostList>
    ...
    <p>
        ...
        The entire group (or at least the majority) only started bonding the year after, but things did improve quickly
    ...
    <p>
        At that point in time, I spent my free time just working on hobby projects.
        Or rather on one big project: Developing my own programming language.
        <em>A link to this will follow when I get around to writing the project entry post about it.</em>
        ...
        This led to an important and yet devastating realization: I cannot and don't want to work as a full-time
        developer.
    ...
    <p>
        I swore to myself that I will not be attending university because I did not want to spend another 3-5 years
    ...
    <p>
        Now let's play another round of "combine and piece together."
        If we take "half-way through school," "no interest in the job you're currently being educated for" and "burnt
        out," what do we get?
        ...
        This mostly consisted of watching an increasing amount of YouTube and spending more time in my fantasy world,
        away from everyone else.
        I eventually did regain some interest in programming again, but it was far away from how much I loved it
        previously.
    </p>

    <p>
        The project in question that got me back on track was my "voice echo" project.
        I recorded my own voice saying various words and phrases and then stitched it together live for three purposes:
    </p>

    <ol>
        <li>Time announcement</li>
        <li>Rail connection announcement</li>
        <li>Weather forecast announcement</li>
    </ol>

    <p>
        Basically, my voice could tell you the current time or generate random railway connections and announce them in
        the style of our national railway service provider (I like trains, leave me alone) or announce randomly
        generated weather forecasts.
        If you want to know more about this, check out the projects post, <em>whenever I get around to writing it</em>.
    </p>

    <p>
        Now let's get to the nitty-gritty stuff and talk about how all of this affected me mentally.
        ...
        With what you should know by now about me, it shouldn't be a surprise when I say that not knowing what to do in
        my free time was not beneficial to my overall situation.
        Since I spent my time outside of school, pretty much just coding, I felt empty when that stopped.
        Without anyone to reach out to, I was alone with my struggles, and for the first time it started actively
        affecting me in my day-to-day life.
    ...
    <p>
        ...
        My mental well-being depended on the interactions I had at school, since I did not have a social life outside of
        that.
        During the summer break, I did not see anyone on a daily basis.
        In fact, I saw no-one at all for a bit over two months.
        My birthday is always at the start of the summer holidays and its always that time of the year, where I think to
        myself, "I've aged another year and still haven't done X".
        A future post about the <em>fear of missing out (<a href="/blog/2023-02-26-mental11/">11. On the Subject of
        FOMO</a>)</em> will go into more detail about what I mean by that.
        Let's just say that the average 17-year-old has typically experienced more than I had at the time (or even at
        the time of writing this lol).
        About a week or so after my birthday is where I'd officially mark the beginning of me being depressed.
        Let me get this straight and remind you: <strong>I am not a professional</strong>.
        I'm saying that I was depressed, but I'm not qualified to actually say that.
        Self-diagnosis can be very dangerous!
        If you are struggling: <strong>Go see a professional and talk to them about it</strong>.
        With that disclaimer out of the way, let's continue.
    </p>

    <p>
        I still remember that night where I was laying in bed, entrenched in my own thoughts and started crying
        uncontrollably.
        I also remember what actually kicked me into this hole.
        Do you remember the movie "Project X"?
        It was a couple of 17-year-olds throwing a party that got out of hand.
        I never watched it, but my brother did, and I remembered one of the songs that got used in
        it: <a href="https://www.youtube.com/watch?v=auzfTPp4moA">Heads will roll from the Yeah Yeah Yeahs</a>.
        Anyway, with the FOMO I mentioned and me being 17, just like the characters, it was the perfect combo for
        disaster.
        One actor of the main characters, <a href="https://en.wikipedia.org/wiki/Thomas_Mann_(actor)">Thomas Mann</a>,
        especially intrigued me.
        One thing that stood out to me was his age when he started acting: 17.
        Seeing a pattern?
        Basically, the quick summary is that I felt shit about being a normal 17-year-old because I thought that I
        needed to have figured everything out and be popular.
        Look... mental health struggles can be so painfully stupid sometimes, and yet these struggles are real and have
        huge consequences.
        Amidst all this chaos, I want to mention one positive thing:
        Through Thomas Mann, I found a movie that was really great and sad to watch, and if you have some spare time, go
        watch it.
        It's called <a href="https://en.wikipedia.org/wiki/Me_and_Earl_and_the_Dying_Girl_(film)">Me and Earl and the
        Dying Girl</a>.
    ...
    <p>
        ...
        I discovered two people that I look up to and through that learned some important lessons and gained a new
        passion.
    ...
    <p>
        ...
        Self-care is important, and since reading my story should also be at least a small learning experience, I feel
        like I need to mention this.

...
<Post data={data.postData} showPostList>
    ...
    <p>
        ...
        This is a fear that sparks this reaction - a <em>fear of missing out (FOMO)</em>.
        Let's dive a bit deeper into this topic and my story, shall we?
    </p>

    <p>
        Early on in <a href="/blog/2023-02-06-mental3/">3. New beginnings - new chances?</a> I first mentioned FOMO in
    ...
    <p>
        ...
        The consumption side actually never affected me too much - after all, drinking a lot mostly just had bad side
        effects that I did not care about anyway.
        And I did not need any substances to get me in a good / happy mood (I mean, maybe medication would have helped
        my depression, but that's a different story).
    </p>
    ...
    <p>
        ...
        To this day this still affects me a little, but I think that it has gotten <em>a lot</em> better.
        However, as a story from university shows: I wasn't even that close and certainly not friends (at least by my
        definition) to the people in question, and yet it still affected me that a group got together and went drinking
        to the club.
        Even though FOMO is something that probably everyone can relate to in some way or another, I still feel a bit
        ashamed / awkward to admit this to myself and now the public.
    ...
    <p>
        ...
        With every year that progresses, or with every birthday that I get older at, I experience more and more
        relationship FOMO.
        I rationally know that I should not stress about this stuff and that there are many other people, my age or even
        older, who are the same.
        But as we all know, when has rationality ever won over irrational fear?
        I feel insecure, awkward and a bit ashamed to be almost 23 (at the time of writing this) and still not have had
        a partner.
        ...
        While I mean this literally (just being physically close and not more), I am also dancing around a few words and
        certain topics right now, but if you can put two and two together, you can probably figure out what I mean.
        Openly speaking about this still makes me very uncomfortable, because this stuff still, sadly, is not openly
        discussed a lot.
        ...
        This is also due to the fact that if I meet someone, chances are that they have already experienced everything
        and I haven't and that makes me a lesser partner or less attractive.
        Which is an extremely stupid thought to have, because if someone actually thinks that, then they are not even
        worth your time.
    ...
    <p>
        ...
        Now this might sound a bit weird or confusing at first but hear me out.
        Whenever you are lacking something or belittling yourself for something, it is always nice to find someone who
        is like you.
        ...
        For example, I would be happy to find someone "popular" on the internet who doesn't drink or is single or
        whatever.
    ...
    <p>
        ...
        <strong>The life you live is totally fine and don't let the lives of others tell you otherwise!</strong>
        You don't need to experience everything, and you don't need to do it in the same order as someone else.
        Just live a happy life and progress at your own pace!

...
<Post data={data.postData} showPostList>
    ...
    <p>
        Our journey begins in the year 2000, when Sony released the PS2, the Concorde crashed and Bill Gates stepped
        down as CEO of Microsoft <a href="https://www.thepeoplehistory.com/2000.html">(<em>Source</em>)</a>.
        If one thing can be taken away from my birth, then it's that I already knew what terrible years lie ahead of
        myself.
        For that reason, or so I like to jokingly tell others, I stopped breathing after being born.
        The doctors, however, convinced me to continue breathing, so thanks I guess, otherwise I wouldn't be able to
        joke about it now.
        My birth was the only time I was ever in a hospital, and I got the full ICU experience.
    ...
    <p>
        ...
        From a very early age, I was interested in and curious about technology, something that has stayed the same
        until today.
        ...
        I hate being on camera <strong>:(</strong>
        Well... it's gotten better recently, but that may be a story for a later post.
    </p>

    <p>
        Something else that I have developed since early on in my life is my observation skill.
        Although some people might say that I'm quite oblivious a lot of times
        (which is true, but only when it comes to social stuff),
        I'd like to think that I still got it in me.
        There is a recording when I was a little kid where I made myself a bottle to drink purely by observing how my
        parents
        were always doing it.
        The only mistake I made was putting on the cap <em>before</em> filling it with hot water.
        ...
        My parents tried a couple of times to teach me how to ski, and I hated it with a passion.
        But when we got back home, I grabbed some yarn and glue and built a small ski lift because it fascinated me.
    </p>

    <p>
        Even though I'm not a sports person in general, as you can probably tell from the last paragraph, a lot of my
        time was spent at our local football club (football as in the one where you kick a ball with your feet, not
        hand-egg, you weirdos).
        My family has more or less always been a football family, spending a lot of time playing in and working for the
        club, and I got dragged along.
        ...
        I'm still helping out occasionally until this day, and it's definitely something that helped with my public
    ...
    <p>
        ...
        Without going into too much detail for now (trust me, we have a lot of posts to go) this led to my brother
        dropping out and me always being self-conscious.

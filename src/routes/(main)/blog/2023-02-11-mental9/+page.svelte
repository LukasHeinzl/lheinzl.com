...
<Post data={data.postData} showPostList>
    ...
    <p>
        We ended <a href="/blog/2023-02-10-mental7/">7. Calm before the storm</a> with me sharing my feelings with K.
        As mentioned this did not go too well.
        What was confusing / disappointing at the time (and still is confusing to this day) is that she did not say
        <em>no</em> to a relationship.
        Rather, she said that she wasn't ready, but that it had nothing to do with me.
    ...
    <p>
        Our friendship had a little dip afterward, but it still went on.
        Very soon I had my first ever encounter with something very unpleasant.
        I still liked her a lot - after all, feelings don't just suddenly disappear just because the other person does
        ...
        With a thousand thoughts rushing through my mind every second, heart rate rapidly increasing and breathing
        suddenly being very difficult, I was overwhelmed.
    ...
    <p>
        ...
        This was a real concern for me, since it was the last school year, and we might lose contact after graduation,
        meaning that I would be all alone again.
        I mentioned that in the future a similar situation will happen again,
        and this "having a friend and soon maybe not seeing them anymore" also repeats itself.
        Since I also had feelings for her, I had the inner urge to always know what she's up to.
        I hate saying this "out loud" (well writing it down counts), but I was starting to become controlling and
        manipulative.
        I constantly wanted to know if she is going out with someone else and if, for a change, she was, I would react
        ...
        At the time, I did not realize this and just made things worse by keeping being pushy and nosey.
        This got so worse that my behavior got more and more childish over time.
    </p>
    ...
    <p>
        ...
        Eventually I started crying around about unimportant stuff like who is who's best friend and "I wanna be your
        best friend" and blah blah blah.
    ...
    <p>
        ...
        Why?
        Well, you see, in Whatsapp, our main form of communication, you can block people from seeing your online status
        and profile picture.
    ...
    <p>
        ...
        I now want to go into a few things about my behavior in a bit more detail because the story itself is a very
        brief summary.
    ...
    <p>
        <strong>Being dependent on a single person is not healthy</strong> - for you and the other person.
    ...
    <p>
        <strong>You cannot own someone else.</strong>
        ...
        They do not have any obligation to tell you, and you have no right in being mad, sad, upset or anything like
        that.
    </p>

    <p>
        <strong>Respect peoples boundaries.</strong>
        ...
        And just because someone does not want to share something with you or answer a question does not mean that there
        is a deeper meaning behind it.
        In almost all cases it just means that they are not comfortable sharing this with you.
    </p>

    <p>
        <strong>Don't be jealous.</strong>
    ...
    <p>
        <strong>Live your own independent life.</strong>
        Rounding this off is this last point.
        You need to accept and love yourself the way you are first.
        You need to be comfortable with yourself and live an independent life.

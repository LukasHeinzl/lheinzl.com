...
<Post data={data.postData} showPostList>
    ...
    <p>
        ...
        I was finished with school, my civil service would not start until January,
        and my internship I did in August is now also over.
        And I did what I could do best: Block off the outside world and stay inside until January.
        The fact that Covid-19 started not long after that, meaning we were <em>forced</em> to stay inside, is a little
        bit funny now in hindsight.
        ...
        This led to old pain resurfacing, but overall it started to get better, slowly.
    ...
    <p>
        ...
        It was, however, another reminder that I <em>had</em> to do something, because I cannot continue living my life
        this way.
    </p>
    ...
    <p>
        ...
        Side-note / fun-fact: One of my songs that might or might not see the light of day is called exactly that and is
        ...
        And let's get this out of the way immediately: After this one session, I never went again because I was still
        too scared to do so.
    </p>

    <p>
        While one visit is not a full diagnosis (please be better than me and actually stay in therapy!), it was still a
        start.
        It revealed two major things for me:
    </p>

    <ul>
        <li>I have a fear of rejection</li>
        <li>I have bonding/trust issues</li>
    </ul>

    <p>
        The first one is my main problem.
        It manifests itself in various different ways.
        It is the reason why I don't have (many) friends, why I have never been in a relationship, why I get anxiety
        when being in public or when meeting new people.
        ...
        This often leads to behaviour where I am belittling myself and saying self-deprecating stuff just to see if
        someone actually cares about me.
        This also plays together with my self-harm thoughts/dreams I talked about
        in <a href="/blog/2023-02-09-mental5/">5. Dance with the reaper</a>.
    </p>

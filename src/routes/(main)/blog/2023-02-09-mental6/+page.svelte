...
<Post data={data.postData} showPostList>
    ...
    <p>
        ...
        After a small intermission in <a href="/blog/2023-02-09-mental5/">5. Dance with the reaper</a> we are now back
        on track.
        As mentioned at the very end of <a href="/blog/2023-02-07-mental4/">4. The plot thickens</a> I discovered two
        people at the end of the summer break.
    ...
    <p>
        ...
        Story time!
        By searching for a different song on YouTube, I found a small excerpt from his program "what." in the search
        results.
        ...
        However, part of me was curious, so eventually after some time I remembered him and decided to watch the video
        for real.
    ...
    <p>
        ...
        It was called "I, Lonely and the modern world", seems familiar? (<a href="/blog/2023-02-03-mental1/">1. I,
        Lonely and the modern world</a>)
        It started out as an album, developed into a live-stand-up program, eventually was turned into a movie before
        being an album again.
        To this day, the ideas are still floating around.
        In fact, there are currently 17 song ideas, ranging from finished title, lyrics and melody in my head to just a
        vague idea.
        ...
        It will probably never happen though, because I started working on another album at a later point in time and
        some of the more concrete songs got transferred to that.
    ...
    <p>
        ...
        At the time of writing, he has the <a
            href="https://www.ted.com/talks/simon_sinek_how_great_leaders_inspire_action">4th most viewed Ted-talk of
        all time</a>.
        It's about "start with why".
        To give a basic summary (please watch it!):
        Communication happens in three layers: what, how and why - the "golden circle".
    ...
    <p>
        ...
        Once you find your why you can adapt your life in a way to live a happy and fulfilled life.
        How can you find your why?
        Great question!
        Simon developed the <a href="/posts/blog/friends_exercise.pdf">friends exercise</a>.
        Basically go through this PDF and start experimenting around.
        I'll continue on with my story in the meantime.
        I found my passion for teaching others - something I've hinted towards
        in <a href="/blog/2023-02-06-mental3/">3. New beginnings - new chances?</a>.
    ...
    <p>
        ...
        Another factor is that, for the first time, I was learning something new in school, in regard to software
        development.
        In late fall, I got the chance to give a presentation about company psychology, and you bet your ass that I
        talked about Simon Sinek.
    ...
    <p>
        ...
        With my passion for programming slightly regained and a moral boost from Bo and Simon on my side, I started to
        improve a bit.
        ...
        We had a lot of fun there together, but the last day for me was overshadowed by the thought of isolation during
        the break.
        To my own surprise, I kept in contact with K a bit which helped a lot.
        On my 18th birthday, I got an acoustic guitar.
        The only thing to mention here is: I did not know how to play and still cannot play until this very day that I'm
        writing this.
    ...
    <p>
        ...
        Anyway...
        I was exited to be back in school, and the break wasn't as bad as previous ones.
        For a small periode of time, I was just a tiny bit optimistic.
        But as my tone might indicate, this was not of permanence.
        In fact, we will be going on a roller coaster pretty soon, that will turn my life upside down and make it even

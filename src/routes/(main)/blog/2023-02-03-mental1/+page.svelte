...
<Post data={data.postData} showPostList>
    <blockquote>
        ...
        <p>
            ...
            I am not a professional, and therefore some of my opinions / advice may not fit you or might even be
            objectively bad.
            <strong>If you are in need of help visit a professional.</strong>
            Most posts will be about events that happened a lot of years ago.
    ...
    <p>
        ...
        Through these (currently) nine years, I've spent most of my time hiding my issues behind a facade of laughter
        and jokes.
    ...
    <p>
        Inspired by writing something else and getting a lot of positive feedback (thank you - you know who you are!),
        I've decided to formulate my thoughts and feelings and create a blog out of them.
        This has multiple benefits that I shall list in the following wondrous bullet-point list:
    </p>

    <ul>
        <li>Text creates distance in space - you don't need to get uncomfortable and share your feelings in person</li>
        <li>Text creates distance in time - you don't chat in real time, it's asynchronous</li>
        <li>Blogging creates distance in people - anyone can read it, not just people who you're close with</li>
        <li>I can try to be funny without getting immediate side-eyes for it</li>
    </ul>
    ...
    <p>
        ...
        Since this will be very personal and contain stuff that I'm not proud of / ashamed about, I'll use jokes to make
        fun of myself.
    ...
    <p>
        ...
        As stated at the very beginning in the disclaimer:
    ...
    <p>
        ...
        Do it, right now!
        Not "maybe later" or in five minutes - <strong>NOW</strong>!
        Just let them know that you care about them - give them a call, send them a lovely message or if they are next
        to you, stop staring at the screen and turn to them.
    ...
    <p>
        ...
        The posts themselves will also portray my life in chronological order,
        so if you're following along, make sure not to miss any!
        This list will, of course, be updated whenever new posts are released.
        Thank you for reading and see you around <strong>:)</strong>
    </p>
</Post>
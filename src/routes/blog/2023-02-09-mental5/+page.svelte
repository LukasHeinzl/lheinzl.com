...
<Post data={data.postData} showPostList>
    ...
    <p>
        No matter what you do, how you live your life or what decisions (good or bad), you make there is one great
        equalizer in life: <em>death</em>.
        ...
        But I'd like to argue that an unnatural death is always just a bit more tragic than a natural one.
    ...
    <p>
        Being alone, depressed and isolated is not a great way to live your life.
        ...
        Quite a lot actually, but mental illness has a way of gas-lighting yourself into thinking that there is
    ...
    <p>
        ...
        following: <em>I'm not doing good.</em>
    </p>

    <p>
        As you can probably imagine, this is <em>not</em> what I did.
        ...
        Apart from one last thing: After that, I've never had any thoughts again that even had remotely something to do
        with suicide.
    ...
    <ol>
        <li>Observe how the others reacted...</li>
        <li>OR... get a new identity and move far away</li>
    </ol>

    <p>
        I started doing some research online about faking one's death and getting new identities.
        I don't remember that much since it has been a few years now, but it wasn't as easy as I first imagined it to
        be.
    ...
    <p>
        ...
        Starting a new life also had the same core difficulties of my current life: I had no-one close to me who would
        support me.
    ...
    <p>
        ...
        I cannot stress one point enough: <strong>If you have any struggles of your own, seek professional
        help.</strong>
        The next post will continue our main story after this small intermission.
        As a finishing exercise for this one, I want you to get in contact with someone you're close with but maybe
